        ...
        >
          ...
          >
            <Card className="flex-col gap-y-4 p-8 bg-card border-border h-full justify-center items-center text-lg">
              ...
              <p className="text-muted-foreground leading-relaxed">
                기술은 결국 비즈니스 문제를 해결하기 위한 도구라고 생각합니다. 기획 팀부터 영업 팀까지 적극적인 소통으로 잠재적 문제를 사전에 발견하고 해결하여&nbsp;
                <b className="font-semibold text-white">최근 6개월간 운영 서비스 CS 0건</b>
                이라는 기록을 달성했습니다.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                또한, 저는 코드의 가독성과 재사용성이 팀의 생산성으로 직결된다고 생각합니다. Atomic Design 패턴을 도입하여 컴포넌트를 구조화하고 Storybook을 활용함으로써 컴포넌트를 문서화하여 협업 효율을 극대화했습니다.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                이러한 경험을 바탕으로&nbsp;
                <Link
